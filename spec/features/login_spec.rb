...
describe 'login to REDTRAIL CRM', js: true do
  ...
  it 'with valid dummy inputs' do
     ...
     #------------------------New Individual------------------------
     find(:css, '#crm_contact_individual_salutation_id').all(:css, 'option').sample.select_option
     ...
     #------------------------spouse------------------------
     find(:css, '#crm_contact_individual_add_spouse_salutation_id').all(:css, 'option').sample.select_option
